...
const fieldClass =
  "mt-3 w-full rounded-[14px] border border-[#817a72] bg-white px-4 py-3 text-[15px] leading-6 text-[#20201d] outline-none transition focus:border-[#3557c4] focus:ring-3 focus:ring-[#3557c4]/20 disabled:cursor-not-allowed disabled:bg-[#eeeae2]";
